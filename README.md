# unrar ![](https://travis-ci.org/droboports/unrar.svg?branch=master)
...
Check the [releases](https://github.com/dhomas1/unrar/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/dhomas1/unrar.git
cd unrar
./build.sh
ls -la *.tgz
```
